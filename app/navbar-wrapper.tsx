...
export function NavbarWrapper() {
    ...
    // TODO (backend theam): This is a temporary solution. We should ideally determine the user's role and render the appropriate navbar based on that,
    // rather than relying on the URL path. 
    if (pathname.startsWith("/components/manager-dashboard")) {
