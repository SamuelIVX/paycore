...
const Bars = ({ size = 24, ...props }: SpinnerVariantProps) => (
  ...
  >
    ...
    `}</style>
    <rect className="spinner-bar text-primary" fill="currentColor" height="22" width="6" x="1" y="1" />
    <rect
      className="spinner-bar spinner-bars-2 text-primary"
      fill="currentColor"
      height="22"
      width="6"
      x="9"
    ...
    />
    <rect
      className="spinner-bar spinner-bars-3 text-primary"
      fill="currentColor"
      height="22"
      width="6"
      x="17"
