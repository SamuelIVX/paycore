...
const defaultNavigationLinks: EmployeeNavbarNavLink[] = [
  ...
  { href: "/employee/internalsearch", icon: <Search />, label: "Internal Search" },
                    ...
                    <NavigationMenuList className="flex-col items-start gap-1">
                      {navigationLinks.map((link) => (
                        <NavigationMenuItem className="w-full" key={link.href}>
                          ...
                          >
                            {link.icon && (
                              <span className="mr-2 h-4 w-4 items-center flex">{link.icon}</span>
                            )}
                            {link.label}
                          </Link>
                        </NavigationMenuItem>
                  ...
                  <NavigationMenuList className="gap-1">
                    {navigationLinks.map((link) => (
                      <NavigationMenuItem key={link.href}>
                        ...
                        >
                          {link.icon && (
                            <span className="mr-2 h-5 w-5 items-center flex">{link.icon}</span>
                          )}
                          {link.label}
                        </Link>
                      </NavigationMenuItem>
